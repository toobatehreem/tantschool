...
<body>
    ...
    <br><br>
      ...
      <div class="container" style="color:rgba(228, 181, 238, 0.822);width:100%;padding:2%;text-align:center;">
       <h1>We'd love to hear from you</h1>
    </div>
    <br><br>

    <div style="padding: 100px;" >
    <div style="background-color:darkviolet; background-size: cover; background-repeat: no-repeat; size: 100%; padding: 50px;">
...
<form onsubmit="myFunction()">
  ...
  <label for="lname" style="color: white;">Message:</label><br>
