...
<div class="container">
    ...
    <div class="card text-center">
      <div class="card-body">
        ...
        <a href="htmlquiz.php" class="btn btn-info transition-hover btn-lg ml-3">HTML Quiz</a>
      </div><br><hr><br>
      <div class="card text-center">
      <div class="card-body">
        ...
        <a href="cssquiz.php" class="btn btn-info transition-hover btn-lg ml-3">CSS Quiz</a>
      </div><br><hr><br>
      <div class="card text-center">
      <div class="card-body">
        ...
        <a href="pythonquiz.php" class="btn btn-info transition-hover btn-lg ml-3">Python Quiz</a>
      </div><br><hr><br>
      <div class="card text-center">
      <div class="card-body">
        ...
        <a href="phpquiz.php" class="btn btn-info transition-hover btn-lg ml-3">PHP Quiz</a>
      </div>
</div>
</div>
