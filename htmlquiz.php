...
<button class="btn btn-primary btn-lg" name="start" float="left">START QUIZ</button> </center><?php } ?></form></div>
...
<tr><td><h3><?php echo @$row['que'];?></h3></td></tr> <?php if($_SESSION['clicks'] > 0 && $_SESSION['clicks'] < 26){ ?>
  ...
  <tr><td><button align="right" class="btn btn-primary" name="click" >Next</button></td></tr> <?php }  
																	?> 
  <form>
 <?php       
