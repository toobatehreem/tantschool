...
<div class="bump"><br><form>
            ...
            <center><img margin-top="2px"margin-bottom="2px" height="100px" width="200px" src="PHP.jpg"> 

<?php if($_SESSION['clicks']==0){ ?> <button class="btn btn-primary btn-lg" name="start" float="left"><span>START QUIZ</span></button> <?php } ?></form></center></div>
...
<tr><td><h3><br><?php echo @$row['que'];?></h3></td></tr> <?php if($_SESSION['clicks'] > 0 && $_SESSION['clicks'] <= 25){ ?>
  ...
  <tr><td><button class="button3new" name="click" >Next</button></td></tr> <?php }  
