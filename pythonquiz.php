...
<?php 				
		...
		$result2 = mysqli_query($con,$fetchqry2);
				...
				?>
<div class="bump"><form><center><img src="python.jpg" height="200px" width="200px"><?php if($_SESSION['clicks']==0){ ?> 
<button class="btn btn-primary btn-lg" name="start" float="left"><span>START QUIZ</span></button> <?php } ?></form></center></div>
...
<tr><td><h3><?php echo @$row['que'];?></h3></td></tr> <?php if($_SESSION['clicks'] > 0 && $_SESSION['clicks'] < 26){ ?>
  ...
  <tr><td><input required type="radio" name="userans" value="<?php echo $row['option4'];?>">&nbsp;<?php echo $row['option4']; ?><br></td></tr>
  <tr><td><button class="btn btn-primary" name="click" >Next</button></td></tr> <?php }  
																	?> 
  <form>
 <?php       
