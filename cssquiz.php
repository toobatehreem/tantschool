...
<?php 															
		...
		$result2 = mysqli_query($con,$fetchqry2);
				...
				?>
<div class="bump"><center><img src="css.jpg" height="200px" width="200px"><?php if($_SESSION['clicks']==0){ ?> <button class="btn btn-primary btn-lg" name="start" float="left"><span>START QUIZ</span></button> <?php } ?></center></div>
