                    ...
                    <div class="col-12 col-md-5">
                        <div class="card text-center" style="width: 100%; height: 25rem;">
                            <div class="card-body">
                                ...
                                <br><br>
                                <a href="htmltutorial.php" class="btn btn-primary">Learn HTML</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-5">
                        <div class="card text-center" style="width: 100%; height: 25rem;">
                            <div class="card-body">
                                ...
                                <br><br>
                                <a href="csstutorial.php" class="btn btn-primary">Learn CSS</a>
                            </div>
                        </div>
                    </div>
                </div> <!-- / .row -->
                    ...
                    <div class="col-12 col-md-5">
                        <div class="card text-center" style="width: 100%; height: 25rem;">
                            <div class="card-body">
                                ...
                                <br><br>
                                <a href="pythontutorial.php" class="btn btn-primary">Learn Python</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 img-skewed img-skewed-right">
                    ...
                    <div class="col-12 col-md-5">
                        <div class="card text-center" style="width: 100%; height: 25rem;">
                            <div class="card-body">
                                ...
                                <br><br>
                                <a href="phptutorial.php" class="btn btn-primary">Learn PHP</a>
                            </div>
                        </div>
                    </div>
                </div> <!-- / .row -->
