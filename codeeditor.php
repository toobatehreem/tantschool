...
<a class="navbar-brand" href="index.php">TantSchool</a>
    ...
    <br><br>
    <div class="container">
      <div class="editor" style="background-color: white;color: black;">
        <div class="row">
            <div class="column">
                <label style="font-size: large;">Output</label>  <br>
                <iframe id="output" style="background-color: white;color:black;border: 3px solid magenta;"></iframe>
            </div>
            <div class="column">
                <table style="background-color: magenta;">
           
                    <tr>
                        <label>Write HTML Code Here</label>             
                    </tr>
                    <tr>      
                            <textarea id="html-code" style="background-color: white;color:black;border: 3px solid magenta;"></textarea>   
                    </tr>
        <label>&nbsp Write CSS Code Here</label>
                    <tr>      
                            <textarea id="css-code" style="background-color: white;color:black;border: 3px solid magenta;"></textarea>
                   </tr>
                    <tr>          
                        <label>&nbsp Write JavaScript Code Here</label>     
                            <textarea id="js-code" style="background-color: white;color:black;border: 3px solid magenta;"></textarea>
                    </tr>     
        </table>
            </div>
          </div>    
